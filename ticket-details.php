...
<div class="ticket-details-page">
  <div class="container">
    <div class="row">
      <div class="col-lg-6"> <!-- Left side column -->
        <div class="left-image">
          <img src="assets/images/banner_bg.png" alt="" />
        </div>
      </div>
      <div class="col-lg-6"> <!-- Right side column -->
        <div class="right-content">
          <h4>Sokari - II</h4>
          <span>1000 Tickets still available</span>
          <ul>
            <li><i class="fa fa-clock-o"></i> Thursday 18:00 to 22:00</li>
            <li>
              <i class="fa fa-map-marker"></i>University Ground
            </li>
          </ul>
          ...
          <div class="warn">
            <p>*You Can Only Buy 2 Tickets For This Show</p>
          </div>
        </div>
      </div>
    </div>
