...
-->
    ...
    <div class="page-heading-about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="font-size: 70px;">We are the Uni Connect</h2>
                    <h4 style="color: #fff;">Step into the world of UniConnect, where events unfold into opportunities, and student ventures receive the audience they deserve.</h4>
    ...
    <div class="about-upcoming-shows">
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <h2 style="color:#492E87">About UniConnect</h2>
                    <br>
                    <h4 style="color: grey;"> Join Us
                        Step into the world of UniConnect, where events unfold into opportunities, and student ventures receive the audience they deserve. Let’s celebrate the academic journey together, creating a community that thrives on connection, innovation, and the shared success of its member</h4> 
                ...
                <div class="col-lg-4">
                    <div class="like-item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="event-details.html"><h4>Dorothea</h4></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="like-item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="event-details.html"><h4> Galena</h4></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="like-item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="event-details.html"><h4>Thala </h4></a>
                        </div>
                    </div>
                </div>
            </div>
